...
class Sample(Data):
    ...
    def __init__(self, data, num = 100):
        ...
        self.positive_class_val = data.get_positive_class_val()
        self.sensitive_attrs = data.get_sensitive_attributes()
        self.privileged_class_names = data.get_privileged_class_names()
    ...
    def data_specific_processing(self, dataframe):
        return dataframe.sample(n = self.num_to_sample)
