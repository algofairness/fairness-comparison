...
def test_adult_data():
    ...
    """ Load the adult data """
    print "\n"
    X, y, x_control = load_adult_data("data/adult/adult-all-numerical-no-race.csv")#, load_data_size=8000) #, load_data_size=16281)
    X_repaired_8, y_repaired_8, x_control_repaired_8 = load_adult_data("data/adult/Repaired_Data_Files/Fixed_Adult_Data_8_sex.csv")#, load_data_size=8000)
    X_repaired_9, y_repaired_9, x_control_repaired_9 = load_adult_data("data/adult/Repaired_Data_Files/Fixed_Adult_Data_9_sex.csv")#, load_data_size=8000)
    X_repaired_1, y_repaired_1, x_control_repaired_1 = load_adult_data("data/adult/Repaired_Data_Files/Fixed_Adult_Data_1_sex.csv")#, load_data_size=8000)
