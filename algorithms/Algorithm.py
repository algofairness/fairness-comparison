...
class Algorithm():
    ...
    def supported_data_types(self):
        ...
        """
        raise NotImplementedError("supported_data_types() in Algorithm is not implemented")
    ...
    # def categorical_data_only(self):
    #     """
    #     Returns True if this algorithm can only handle categorical data as input.
    #     """
    #     return False
