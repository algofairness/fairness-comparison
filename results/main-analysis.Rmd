...
```{r}
num <- read.csv("two-gaussians_sensitive-attr_numerical.csv", check.names=FALSE)
nbs <- read.csv("two-gaussians_sensitive-attr_numerical-binsensitive.csv", check.names=FALSE)
