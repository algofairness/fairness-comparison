...
def classify_ricci(filename, sensitive_attr, x_train, y_train, x_control_train, x_test, y_test, x_control_test):
    clf = SVC()
    clf.fit(x_train, y_train)
    predictions = clf.predict(x_test)
    score = clf.score(x_test, y_test)
...
def classify_retailer(filename, sensitive_attr, x_train, y_train, x_control_train, x_test, y_test, x_control_test):
