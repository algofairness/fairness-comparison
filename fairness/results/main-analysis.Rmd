...
load_dataset = function(name, attribute) {
  ...
  bad_names = c(
    str_c(attribute, "-accuracy"),
    str_c(attribute, "-calibration+"),
    str_c(attribute, "-calibration-"),
    str_c(attribute, "-TNR"),
    str_c(attribute, "-TPR"))
  ...
  # dataset[, !(colnames(dataset) %in% bad_names)]
  dataset[, c("name", "attribute", "algorithm",
     "DIbinary", "DIavgall", "CV", "TNR", "accuracy", "BCR", "MCC", 
     "sensitive-accuracy", 
     "0-accuracy", "1-accuracy", 
     "sensitive-calibration+",
     "sensitive-TNR", 
...
make_correlation = function(dataset) {
  compute_measure_correlation_matrix(dataset, 
   c("DIbinary", "DIavgall", "CV", "TNR", "accuracy", "BCR", "MCC", 
     "sensitive-accuracy", 
     "0-accuracy", "1-accuracy", 
     "sensitive-calibration+",
     "sensitive-TNR", 
